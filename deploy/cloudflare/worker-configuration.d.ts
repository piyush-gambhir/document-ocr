/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57bfb4f94f00b8b9657d88e9ff982705)
// Runtime types generated with workerd@1.20260903.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	DOCUMENT_OCR_KYC_LANGS: "en";
	CONTAINER_INSTANCES: "2";
	CONTAINER_IDLE_TIMEOUT: "10m";
	API_TOKEN: string;
	OCR: DurableObjectNamespace<import("./src/index").OcrContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OcrContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOCUMENT_OCR_KYC_LANGS" | "CONTAINER_INSTANCES" | "CONTAINER_IDLE_TIMEOUT" | "API_TOKEN">> {}
}
