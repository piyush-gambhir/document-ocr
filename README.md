...
and failures, and the [measured MRZ improvements](benchmarks/MRZ_IMPROVEMENTS.md)
for the latest before/after comparison. The [dataset coverage map](benchmarks/DOCUMENT_DATASET_COVERAGE.md)
